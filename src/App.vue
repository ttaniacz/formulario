  <template> <!--Inicio do template geral-->
  <div id="app"> <!--Inicio da Div app-->
    <Card class="grid"> <!--Inicio do Card-->
    <template #content>
        <!--Configuração do Texto-->
         <div class="text-1000 font-bold m-2 flex align-items-center justify-content-center">
         Cadastro do Animal 
         </div>
         <br>
        <!--Inicio da grid-->
        ...
        <div class="p-fluid grid formgrid"> 
          ...
          <div class="col-6">
            <span class="p-float-label">
              <InputText id="username1" type="text" v-model="value1" />
              <label for="username1">Nome do dono do animal</label>
            </span>
          </div>
          <!--class telefone pessoa-->
          <div class="col-3">
            <span class="p-float-label">
              <InputMask id="telefone" mask="(99) 99999-9999" v-model="val1" />
          ...
          <div class="mt-4 col-3">
            <Dropdown v-model="selectCategoria" :options="animal" optionLabel="nomeAnimal"
        ...
        <div class="col-2 mr-2">
          <Button label="Salvar" class="p-button-raised" />
        </div>
        </div><!--Final da grid--> 
        </panel> 
        

      </template> <!--Final do tamplete #content-->
      </Card> <!--Final do Card-->
      </div> <!--Final da Div app-->
